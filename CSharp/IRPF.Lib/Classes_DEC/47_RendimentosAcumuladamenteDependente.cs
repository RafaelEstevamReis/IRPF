...
{
    public class R47_RendimentosAcumuladamenteDependente : IFixedLenLine
    {
        ...
        public int CD_RRA_Dependente { get; set; }
        ...
        public int NR_MesRecebimento { get; set; }

        [Index(12), Type(TipoRegistro.C), Length(6)]
        public string FILLER { get; set; }

        [Index(13), Type(TipoRegistro.N), Length(1)]
        public string OP_Tributacao { get; set; }

        [Index(14), Type(TipoRegistro.N), Length(4, 1)]
        ...
        [Index(18), Type(TipoRegistro.N), Length(10)]
